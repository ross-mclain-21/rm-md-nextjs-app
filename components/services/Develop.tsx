...
export default function Develop() {
  ...
  return (
    <div ref={developRef} className={'vh-100 d-flex flex-column '}>
      <motion.div
        ref={ref}
        animate={controls}
        initial="hidden"
        ...
        <div className="d-flex flex-column flex-fill justify-content-center services-container">
          <div className="mb-5">
            ...
            <div className="col-lg-6 mb-md-0 mb-3">
              <div className="row align-items-stretch justify-content-center mb-2">
                ...
                <div className="col-sm-3 d-flex align-items-stretch">
                  <div className="skill-icon skill-icon-image flex-fill">
                    <Image src={nextJsLogo} width={95} height={55} alt={'typescript'} />
                  </div>
                </div>
                <div className="col-sm-3">
                  <div className="skill-icon">
              ...
              <div className="row align-items-stretch justify-content-center mb-2">
                ...
                <div className="col-sm-3">
                  <div className="skill-icon skill-icon-image">
                    <Image src={typeScriptLogo} width={56} height={63} alt={'typescript'} />
                  </div>
                </div>
                <div className="col-sm-3">
                  <div className="skill-icon">
